...
authd is an authentication daemon for cloud-based identity providers (MS Entra ID, Google IAM). It's a hybrid Go/Rust project that provides:
...
go generate ./pam/ && go build -tags pam_binary_exec -o ./pam/authd-pam ./pam  # PAM
