// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -no-main -tags !pam_binary_cli && pam_debug -build-tags pam_gdm_debug -no-generator -output pam_module_debug.go"; DO NOT EDIT.
