// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -no-main -tags !pam_binary_cli && pam_debug -build-tags pam_gdm_debug -output pam_module_debug.go"; DO NOT EDIT.

//go:build !pam_binary_cli && pam_debug

//go:generate go build "-ldflags=-extldflags -Wl,-soname,pam_authd.so" -buildmode=c-shared -o pam_authd.so -tags go_pam_module,pam_gdm_debug
