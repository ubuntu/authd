// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -no-main -tags !withpamclient && pam_debug -build-tags pam_gdm_debug -output pam_module_debug.go"; DO NOT EDIT.

//go:build !withpamclient && pam_debug
