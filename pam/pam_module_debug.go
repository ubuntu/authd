// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -no-main -tags pam_debug -build-tags pam_gdm_debug,withgdmmodel -build-flags "-gcflags=all=-N -l" -output pam_module_debug.go"; DO NOT EDIT.
