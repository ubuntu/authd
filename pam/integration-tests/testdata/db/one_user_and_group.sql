...
INSERT INTO users VALUES('user1',1111,1111,replace('User1 gecos\nOn multiple lines','\n',char(10)),'/home/user1','/bin/sh','broker-id');
CREATE TABLE GROUPS (
    name TEXT NOT NULL,  -- Uniqueness is enforced by the index below
...
INSERT INTO "GROUPS" VALUES('group1',1111,'user1');
...
INSERT INTO users_to_groups VALUES(1111,1111);
