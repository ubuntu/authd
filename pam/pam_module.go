// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -no-main -tags !pam_debug && withgdmmodel -build-tags withgdmmodel"; DO NOT EDIT.

//go:build !pam_debug && withgdmmodel

//go:generate go build "-ldflags=-extldflags -Wl,-soname,pam_authd.so" -buildmode=c-shared -o pam_authd.so -tags go_pam_module,withgdmmodel
