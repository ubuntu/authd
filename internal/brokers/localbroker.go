...
// We still need localBroker to implement the brokerer interface,
// even though this type will not be interacted with by the daemon.
//
//nolint:unused
...
//
//nolint:unused
func (b localBroker) NewSession(ctx context.Context, username, lang, mode string) (
...
//
//nolint:unused
func (b localBroker) GetAuthenticationModes(ctx context.Context, sessionID string,
...
//
//nolint:unused
func (b localBroker) SelectAuthenticationMode(ctx context.Context, sessionID, authenticationModeName string) (
...
//
//nolint:unused
func (b localBroker) IsAuthenticated(ctx context.Context, sessionID, authenticationData string) (
