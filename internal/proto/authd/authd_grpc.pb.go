...
const (
	...
	NSS_DisablePasswd_FullMethodName    = "/authd.NSS/DisablePasswd"
	NSS_EnablePasswd_FullMethodName     = "/authd.NSS/EnablePasswd"
)
...
type NSSClient interface {
	...
	DisablePasswd(ctx context.Context, in *DisablePasswdRequest, opts ...grpc.CallOption) (*Empty, error)
	EnablePasswd(ctx context.Context, in *EnablePasswdRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *nSSClient) DisablePasswd(ctx context.Context, in *DisablePasswdRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, NSS_DisablePasswd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nSSClient) EnablePasswd(ctx context.Context, in *EnablePasswdRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, NSS_EnablePasswd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NSSServer interface {
	...
	DisablePasswd(context.Context, *DisablePasswdRequest) (*Empty, error)
	EnablePasswd(context.Context, *EnablePasswdRequest) (*Empty, error)
...
func (UnimplementedNSSServer) DisablePasswd(context.Context, *DisablePasswdRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisablePasswd not implemented")
}
func (UnimplementedNSSServer) EnablePasswd(context.Context, *EnablePasswdRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnablePasswd not implemented")
}
...
func _NSS_DisablePasswd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisablePasswdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NSSServer).DisablePasswd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NSS_DisablePasswd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NSSServer).DisablePasswd(ctx, req.(*DisablePasswdRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _NSS_EnablePasswd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnablePasswdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NSSServer).EnablePasswd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NSS_EnablePasswd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NSSServer).EnablePasswd(ctx, req.(*EnablePasswdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NSS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DisablePasswd",
			Handler:    _NSS_DisablePasswd_Handler,
		},
		{
			MethodName: "EnablePasswd",
			Handler:    _NSS_EnablePasswd_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "authd.proto",
