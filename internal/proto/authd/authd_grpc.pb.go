...
const (
	...
	UserService_GetGroupByGID_FullMethodName  = "/authd.UserService/GetGroupByGID"
...
type UserServiceClient interface {
	...
	GetGroupByGID(ctx context.Context, in *GetGroupByIDRequest, opts ...grpc.CallOption) (*Group, error)
...
func (c *userServiceClient) GetGroupByGID(ctx context.Context, in *GetGroupByIDRequest, opts ...grpc.CallOption) (*Group, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Group)
	err := c.cc.Invoke(ctx, UserService_GetGroupByGID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetGroupByGID(context.Context, *GetGroupByIDRequest) (*Group, error)
...
func (UnimplementedUserServiceServer) GetGroupByGID(context.Context, *GetGroupByIDRequest) (*Group, error) {
...
func _UserService_GetGroupByGID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGroupByIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetGroupByGID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetGroupByGID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetGroupByGID(ctx, req.(*GetGroupByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetGroupByGID_Handler,
		},
		{
