...
const file_authd_proto_rawDesc = "" +
	...
	"\x17SetDefaultBrokerForUser\x12\x13.authd.SDBFURequest\x1a\f.authd.Empty2\xe7\x03\n" +
	"\vUserService\x129\n" +
	...
	"\n" +
	"UnlockUser\x12\x18.authd.UnlockUserRequest\x1a\f.authd.Empty\x122\n" +
	"\tSetUserID\x12\x17.authd.SetUserIDRequest\x1a\f.authd.Empty\x12<\n" +
