...
// SetUserID updates the UID of a user. It also updates the GID of the user's private group to match the new UID.
func (m *Manager) SetUserID(username string, newUID uint32) error {
	...
	if existingUser.Name == username {
		...
		return nil // No update needed if the user already has the new UID
	}
