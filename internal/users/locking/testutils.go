...
// Z_ForTests_OverrideLockingAsLockedExternally is a function to
// override the locking functions for testing purposes.
// It simulates the real behavior but without actual file locking.
// This locks the database when called, the lock can be both removed using
// [WriteUnlock] or cancelling the context. It also implicitly calls
// [Z_ForTests_RestoreLocking] once the test is completed.
//
// nolint:revive,nolintlint // We want to use underscores in the function name here.
