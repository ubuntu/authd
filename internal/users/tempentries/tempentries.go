...
func (l *TemporaryRecordsWithLock) mustBeLocked() (cleanup func()) {
...
func (l *TemporaryRecordsWithLock) lock() (err error) {
...
func (l *TemporaryRecordsWithLock) unlock() (err error) {
...
func (r *TemporaryRecords) LockForChanges() (tra *TemporaryRecordsWithLock, unlock func() error, err error) {
	defer decorate.OnError(&err, "failed to lock for changes")

	lockedRecords := &TemporaryRecordsWithLock{tr: r}
